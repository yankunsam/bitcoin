...
static CBlock CreateGenesisBlock(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    const char* pszTimestamp = "Initialize: 2018/03/12";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1520846186, 1257274128, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        //assert(consensus.hashGenesisBlock == uint256S("0x000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f"));
        assert(consensus.hashGenesisBlock == uint256S("00000000e12ddeed723d4c36a95b15aee7e0618afc0590f3ca4c73384fb950b1"));
        //assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        assert(genesis.hashMerkleRoot == uint256S("31585970d17ab776ba98e48b27c95cc7ca291d1712e49be71de27f003cfec9b6"));
